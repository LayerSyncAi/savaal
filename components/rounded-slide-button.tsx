...
export const RoundedSlideButton = ({
        ...
        return (
                <Link
                        ...
                        className={`
                                relative z-0 flex items-center gap-2 overflow-hidden rounded-lg border border-[var(--hover-color)]
                                px-4 py-2 font-semibold uppercase text-neutral-900 transition-all duration-500
                                ...
                                hover:scale-105 hover:text-white hover:before:translate-x-[0%]
