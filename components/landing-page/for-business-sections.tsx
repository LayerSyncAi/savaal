...
const sections = [
  {
    ...
    content: (
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-2" id="consultancy">
        <div>
          ...
          <p className="mt-4 text-[var(--paragraph-color)]">
            From mystery audits to immersive workshops, our consultants translate the Savaal standards into daily service rituals, beverage programs, and guest journey design.
          </p>
        ...
        <div className="rounded-2xl bg-[rgb(var(--secondary-rgb)/0.6)] p-6">
          <p className="text-sm font-semibold text-[var(--heading-color)]">Book a training intensive</p>
  ...
  },
  {
    ...
    content: (
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-2" id="events">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.4em] text-[var(--accent)]">
            Events & Curations
          </p>
          ...
          <p className="mt-4 text-[var(--paragraph-color)]">
            Pop-up dinners, mixology showcases, and cultural festivals designed to highlight Zimbabwe&apos;s culinary icons and rising stars.
          </p>
        </div>
        <div className="rounded-2xl bg-[rgb(var(--secondary-rgb)/0.6)] p-6">
  ...
  },
  {
    ...
    content: (
      <div className="mx-auto max-w-4xl px-6 pb-24 pt-12 text-center" id="judging">
        <h2 className="text-2xl font-semibold text-[var(--heading-color)]">Judging</h2>
        <p className="mt-4 text-[var(--paragraph-color)]">
          Savaal Judges are cultural tastemakers who discreetly assess venues via the Savaal Scorecard. Their evaluations ensure that every listing meets the promise of elevated service, cuisine, and cultural immersion.
        </p>
        <Link
  ...
  },
  {
    ...
    content: (
      <div className="mx-auto max-w-4xl px-6 pb-24 pt-12 text-center text-white" id="partnerships">
        <p className="text-sm uppercase tracking-[0.4em] text-[var(--peach)]">For Businesses</p>
        <h2 className="mt-4 text-3xl font-semibold">
          Elevate Your Business. Request a Savaal Certification Audit or Partnership.
        </h2>
        <p className="mt-4 text-[var(--peach-light)]">
          Engage with our consultancy team for training, audits, or bespoke cultural collaborations that spotlight your venue on the continent&apos;s most trusted hospitality guide.
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link href="/contact" className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-[var(--primary)] shadow-lg">
            Request Consultancy
          </Link>
          <Link
            href="/partnerships"
    ...
    <div className="bg-white">
      {sections.map((section) => (
        <section id={section.id} key={section.id}>
          <TextParallaxContent imgUrl={section.imgUrl} subheading={section.subheading} heading={section.heading}>
            {section.content}
          </TextParallaxContent>
        </section>
      ))}
