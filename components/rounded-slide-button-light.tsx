...
export const RoundedSlideButtonLight = ({
        ...
        return (
                <Link
                        ...
                        className={`
                                relative z-0 inline-flex items-center gap-2 overflow-hidden border border-(--hover-color)]
                                ...
                                hover:scale-[var(--hover-scale)] hover:text-white hover:before:translate-x-[0%]
