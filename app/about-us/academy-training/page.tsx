                ...
                <section className="mx-auto flex max-w-5xl flex-col gap-10 px-6 py-20">
                        ...
                        <div className="grid gap-6 rounded-3xl bg-[rgb(var(--secondary-rgb)/0.6)] p-6 shadow-lg md:grid-cols-[1.1fr,0.9fr]">
                                <div className="space-y-4 rounded-2xl bg-white p-6 shadow-sm">
                                        <h2 className="text-2xl font-semibold text-neutral-900">Our promise to funders</h2>
                                        <p className="text-neutral-700">
                                                Every dollar fuels practical training that protects guests and uplifts
                                                local producers. We report on community placements, job creation, and
                                                the number of venues that graduate into the Guide after mentorship.
                                        </p>
                                        <ul className="space-y-2 text-sm font-medium text-neutral-800">
                                                <li>• Transparent metrics on participant outcomes and placements</li>
                                ...
                                <div className="space-y-4 rounded-2xl border border-amber-100 bg-gradient-to-br from-amber-50 via-white to-amber-100/60 p-6">
                                        ...
                                        <p className="text-lg text-neutral-800">
                                                Judges, taste hunters, and aspiring chefs work side by side to raise service
                                                standards while strengthening food security for the people they serve.
                                        </p>
                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                <div className="rounded-xl bg-white p-4 shadow-sm">
                                                        ...
                                                        <p className="mt-2 text-sm text-neutral-700">
                                                                Placements in public cafeterias, school kitchens, and regional tourism hubs
                                                                ensure training benefits everyday diners.
                                                        </p>
                                                </div>
                                                <div className="rounded-xl bg-white p-4 shadow-sm">
                                                        <p className="text-xs font-semibold uppercase tracking-wide text-amber-600">
                                                        ...
                                                        <p className="mt-2 text-sm text-neutral-700">
                                                                Stipends, apprenticeships, and entrepreneurship clinics reduce barriers for
                                                                young people entering hospitality careers.
                                                        </p>
                                                </div>
                                        </div>
                                </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                                {trainingTracks.map((track) => (
                                        <div key={track.title} className="rounded-2xl border border-amber-100 bg-white p-6 shadow-sm">
