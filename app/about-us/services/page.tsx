    ...
    <div className="bg-neutral-950 text-white">
      <section className="mx-auto flex max-w-5xl flex-col gap-10 px-6 py-24">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-bold text-white">The Savaal Ecosystem</h1>
          <p className="text-lg text-white/80">
            Explore the programs and touchpoints that make Savaal more than a guide.
            Each service strengthens the hospitality community, creates discovery moments,
            and reinforces a shared standard of excellence.
          </p>
        </div>
        ...
        <Link
          href="/about-us"
          className="inline-flex w-fit items-center gap-2 text-sm font-semibold text-amber-200 transition hover:text-white"
        >
          Back to About us
          <FiArrowUpRight />
        </Link>
  ...
  return (
    <article className="group relative flex h-64 flex-col justify-end overflow-hidden rounded-2xl border border-white/10 bg-neutral-900/60 p-6 text-white transition duration-300 hover:border-white/40 md:h-80">
      <div className="pointer-events-none absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100">
        <div
          className="absolute inset-0 scale-100 bg-cover bg-center bg-no-repeat opacity-70 blur-sm transition duration-500 group-hover:scale-105 group-hover:blur-0"
      ...
      <div className="relative z-10 flex flex-col gap-3">
        ...
        <h2 className="text-2xl font-semibold leading-tight transition-transform duration-500 group-hover:-translate-y-1">
          {title}
        </h2>
...
const TitleCard = () => {
  return (
    <div className="flex h-64 flex-col justify-between rounded-2xl border border-white/10 bg-gradient-to-br from-amber-400/20 via-amber-200/10 to-transparent p-6 text-white shadow-inner md:h-80">
      <div>
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-amber-200">What we offer</p>
        <h2 className="mt-2 text-3xl font-semibold text-white">
          Services that uplift cultural hospitality.
        </h2>
        <p className="mt-4 text-sm text-white/70">
          From audits to community programming, each initiative amplifies authentic hosts across the continent.
        </p>
      </div>
      <Link
        href="/contact"
